...
public final class Dashboard extends javax.swing.JFrame {
    ...
    public void showBarChart() {
        ...
        JFreeChart chart = ChartFactory.createBarChart("Book Issued As Per Month", "Months", "No of Books", dataset, PlotOrientation.VERTICAL, false, true, false);
    ...
    public final void getImage() {
        try {
            ...
            while (rs.next()) {
                switch (i) {
                    case 1:
                        showBookDetail(image1, rs.getString("book_name"), rs.getBytes("image"));
                        break;
                    case 2:
                        showBookDetail(image2, rs.getString("book_name"), rs.getBytes("image"));
                        break;
                    case 3:
                        showBookDetail(image3, rs.getString("book_name"), rs.getBytes("image"));
                        break;
                    case 4:
                        showBookDetail(image4, rs.getString("book_name"), rs.getBytes("image"));
                        break;
                    case 5:
                        showBookDetail(image5, rs.getString("book_name"), rs.getBytes("image"));
                        break;
                    case 6:
                        showBookDetail(image6, rs.getString("book_name"), rs.getBytes("image"));
                        break;
    ...
    public void showBookDetail(JLabel imgLabel, String bookName, byte[] img) {
//        nameLabel.setText(bookName);
        ImageIcon image = new ImageIcon(img);
        Image im = image.getImage();
        Image myimage = im.getScaledInstance(220, 270, Image.SCALE_SMOOTH);
    ...
    private void initComponents() {
        ...
        jLabel15.setText("  View Defaulter List");
        ...
        kGradientPanel1.add(panel_piechart, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 330, 670, 630));

        jLabel12.setFont(new java.awt.Font("Felix Titling", 1, 36)); // NOI18N
        ...
        kGradientPanel1.add(image6, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 680, 220, 275));

        image2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 102), 2, true));
        kGradientPanel1.add(image2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 330, 220, 275));

        image1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 102), 2, true));
        kGradientPanel1.add(image1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 330, 220, 275));

        image3.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 102), 2, true));
        kGradientPanel1.add(image3, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 330, 220, 275));

        image4.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 102), 2, true));
        kGradientPanel1.add(image4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 680, 220, 275));

        image5.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 102), 2, true));
        kGradientPanel1.add(image5, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 680, 220, 275));
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/adminIcons/userWelcome1.png"))); // NOI18N
        ...
        kGradientPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, kGradientPanel3Layout.createSequentialGroup()
                ...
                .addComponent(lbl_date, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(45, 45, 45)
                ...
                .addGroup(kGradientPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(kGradientPanel3Layout.createSequentialGroup()
                        .addGroup(kGradientPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jLabel13, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
...
//        setLocation(evt.getXOnScreen()-Position_x,evt.getYOnScreen()-Positio_y);
    ...
    private void lbl_dateMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_dateMousePressed
        // TODO add your handling code here:
        new Calendar().setVisible(false);
    }//GEN-LAST:event_lbl_dateMousePressed
